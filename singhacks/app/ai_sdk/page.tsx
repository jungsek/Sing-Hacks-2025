    ...
    <div className="py-8">
      <GuideInfoBox>
        <div className="flex flex-col items-stretch gap-4">
          <p>
            The below section contains two examples using the LangChain.js framework, along with
            helper functions from the experimental AI SDK RSC showing off how to create complex,
            full stack streaming applications with React Server Components.
          </p>

          <div className="grid grid-cols-[1fr,auto] items-center gap-x-2 gap-y-6">
            <p className="m-0 text-left">
              The <strong>Agents</strong> example contains an agent which streams data back to the
              client using the{" "}
              <a
            ...
            <p className="m-0 text-left">
              The <strong>Tools</strong> example shows how to invoke a simple tool calling model,
