...
export default function TransactionsPage() {
  return (
    <main className="flex flex-col gap-8 p-8 bg-background min-h-screen">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Transaction Alerts</h1>
      ...
      <Card className="shadow-md border-border/70 bg-background/80 backdrop-blur">
        <CardHeader>
          <CardTitle className="text-lg font-semibold">
            Latest Transaction Monitoring Feed
          </CardTitle>
          <CardDescription>
              ...
              <tbody className="divide-y divide-border/40">
                {transactions.map((txn) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">{txn.amount} {txn.currency}</td>
